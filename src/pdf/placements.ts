...
export type FieldPlacement = {
  ...
  align?: 'left' | 'center' | 'right'; verticalAlign?: 'top' | 'middle' | 'bottom'; multiline?: boolean; maxLines?: number; lineHeight?: number; paddingMm?: number;
};
...
const narrative = { fontSizePt: 11, minFontSizePt: 8, verticalAlign: 'bottom' as const, multiline: true, maxLines: 2, lineHeight: 1.28, paddingMm: 1.8 };
...
export const textPlacements: Record<TextPlacementKey, FieldPlacement> = {
  ...
  inviterPhone: calibrate(rect({ xPt: 189.48, yPt: 567.39, widthPt: 188.32, heightPt: 16.80 }, single), { yMm: -0.35 }),
  inviterExtension: calibrate(rect({ xPt: 418.96, yPt: 567.19, widthPt: 68.99, heightPt: 16.80 }, center), { yMm: -0.70 }),
  ...
  contactPhone: calibrate(rect({ xPt: 189.48, yPt: 477.23, widthPt: 188.14, heightPt: 16.80 }, single), { yMm: -0.35 }),
  contactExtension: calibrate(rect({ xPt: 417.58, yPt: 477.28, widthPt: 70.95, heightPt: 16.80 }, center), { yMm: -0.70 }),
